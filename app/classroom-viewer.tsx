...
const SCHOOL_FLOORS: SchoolFloorShape[] = [
  {
    floor: "1F",
    corridor: "M188 14 H226 V88 H386 V126 H356 V244 H240 V276 H192 V318 H150 V334 H92 V314 H188 Z M226 88 H250 V48 H386 V88 M356 126 H406 V260 H382 V126 M192 318 H238 V356 H208 V374 H146 V354 H92 V334",
    rooms: [
    ...
    outlines:[
      { d:"M6 10 H188 V316 H150 V334 H92 V316 H26 V304 H6 Z", width:1.8 },
      { d:"M398 10 H484 V332 H404 V316 H398 Z", width:1.8 },
      { d:"M70 42 H188 V92 H150 V160 H118 V246 H70 Z", dashed:true, width:1.45 },
      { d:"M118 92 H188 V160 H148 V206 H118 Z", dashed:true, width:1.45 },
      { d:"M152 302 H238 V340 H208 V360 H138 V342 H96 V328", dashed:true, width:1.45 },
      { d:"M238 276 H356 V318 H316 V340 H276 V338 H238 Z", dashed:true, width:1.45 },
      { d:"M356 244 H406 V304 H384 V318 H356 Z", dashed:true, width:1.45 },
      { d:"M398 264 H484 V352 H454 V370 H406 V350 H398 Z", dashed:true, width:1.45 },
    ],
  },
  {
    floor: "2F",
    corridor: "M176 18 H222 V88 H398 V126 H360 V246 H240 V286 H178 V372 H132 V388 H94 V372 H176 Z M222 88 H258 V48 H398 V88 M360 126 H412 V266 H388 V126 M178 334 H226 V372 H240 V404 H178 Z",
    rooms: [
    ...
    outlines:[
      { d:"M6 10 H132 V374 H94 V390 H34 V374 H8 Z", width:1.8 },
      { d:"M406 12 H482 V344 H448 V364 H410 Z", width:1.8 },
      { d:"M0 72 H18 V292 H0 Z", width:1.55 },
      { d:"M128 334 H178 V384 H128 Z", width:1.55 },
      { d:"M238 286 H360 V338 H320 V360 H238 Z", width:1.55 },
      { d:"M178 372 H240 V406 H210 V424 H146 V406 H112 V390", width:1.55 },
      { d:"M410 322 H482 V372 H450 V392 H410 Z", width:1.55 },
    ],
  },
  {
    floor: "3F",
    corridor: "M174 18 H222 V88 H400 V126 H362 V248 H238 V290 H176 V386 H128 V404 H94 V386 H174 Z M222 88 H258 V48 H400 V88 M362 126 H412 V260 H388 V126 M176 348 H224 V386 H238 V418 H176 Z",
    rooms: [
    ...
    outlines:[
      { d:"M8 12 H132 V416 H96 V432 H34 V416 H8 Z", width:1.8 },
      { d:"M410 12 H484 V386 H448 V404 H412 Z", width:1.8 },
      { d:"M128 360 H176 V416 H128 Z", width:1.5 },
      { d:"M238 290 H362 V344 H322 V366 H238 Z", width:1.5 },
      { d:"M176 386 H238 V420 H208 V438 H146 V420 H110 V404", width:1.5 },
      { d:"M412 344 H484 V402 H452 V420 H412 Z", width:1.5 },
    ],
  },
  {
    floor: "4F",
    corridor: "M160 20 H212 V90 H404 V128 H370 V254 H228 V296 H162 V388 H112 V404 H74 V388 H160 Z M212 90 H252 V48 H404 V90 M370 128 H414 V266 H392 V128 M160 350 H210 V388 H228 V420 H162 Z",
    rooms: [
    ...
    elevators:[{x:382,y:154}],
    outlines:[
      { d:"M4 12 H116 V390 H82 V410 H26 V390 H6 Z", width:1.8 },
      { d:"M412 12 H486 V390 H450 V410 H414 Z", width:1.8 },
      { d:"M0 4 H164 V18 H116 V390 H82 V410 H26 V390 H0 Z", width:1.55 },
      { d:"M228 296 H370 V350 H328 V372 H228 Z", width:1.55 },
      { d:"M162 388 H228 V422 H198 V440 H136 V422 H98 V406", width:1.55 },
      { d:"M414 330 H486 V420 H450 V438 H414 Z", width:1.55 },
    ],
  },
  {
    floor: "5F",
    corridor: "M204 66 H396 V108 H358 V244 H240 V280 H206 V316 H176 V334 H140 V316 H204 Z M204 66 H242 V48 H396 V66 M358 108 H414 V252 H390 V108 M206 280 H238 V338 H206 Z",
    rooms: [
    ...
    outlines:[
      { d:"M92 58 H206 V416 H160 V438 H104 V416 H94 Z", width:1.8 },
      { d:"M412 12 H486 V426 H450 V446 H414 Z", width:1.8 },
      { d:"M0 44 H92 V58 H206 V416 H160 V438 H104 V416 H42 V402 H0 Z", width:1.55 },
      { d:"M206 280 H358 V336 H320 V360 H206 Z", dashed:true, width:1.45 },
      { d:"M206 316 H238 V372 H208 V392 H146 V374 H104 V356", dashed:true, width:1.45 },
      { d:"M238 336 H358 V392 H318 V414 H238 Z", dashed:true, width:1.45 },
      { d:"M358 244 H414 V318 H390 V336 H358 Z", dashed:true, width:1.45 },
      { d:"M414 360 H486 V446 H452 V462 H414 Z", width:1.55 },
    ],
  },
  {
    floor: "6F",
    corridor: "M244 88 H462 V130 H422 V178 H244 Z M462 88 H488 V144 H462 Z M244 130 H214 V178 H244 Z",
    rooms: [
    ...
    outlines:[
      { d:"M236 8 H518 V186 H492 V430 H450 V186 H236 Z", width:1.85 },
      { d:"M214 4 H236 V186 H244 V208 H214 Z", width:1.5 },
      { d:"M450 178 H492 V430 H468 V452 H446 V430", width:1.5 },
      { d:"M492 186 H518 V450 H488 V468 H450 V450", width:1.5 },
    ],
  },
];
